...
public final class SellGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.grpc.client.stub.Airsell.SellRequest,
      com.grpc.client.stub.Airsell.SellResponse> getCreateSellMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "createSell",
      requestType = com.grpc.client.stub.Airsell.SellRequest.class,
      responseType = com.grpc.client.stub.Airsell.SellResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.grpc.client.stub.Airsell.SellRequest,
      com.grpc.client.stub.Airsell.SellResponse> getCreateSellMethod() {
    io.grpc.MethodDescriptor<com.grpc.client.stub.Airsell.SellRequest, com.grpc.client.stub.Airsell.SellResponse> getCreateSellMethod;
      ...
      synchronized (SellGrpc.class) {
        if ((getCreateSellMethod = SellGrpc.getCreateSellMethod) == null) {
          SellGrpc.getCreateSellMethod = getCreateSellMethod = 
              io.grpc.MethodDescriptor.<com.grpc.client.stub.Airsell.SellRequest, com.grpc.client.stub.Airsell.SellResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "com.grpc.poc.Sell", "createSell"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.grpc.client.stub.Airsell.SellRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.grpc.client.stub.Airsell.SellResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.grpc.client.stub.Airsell.SellRequest,
      com.grpc.client.stub.Airsell.SellResponse> getUpdateSellMethod;
  ...
  public static io.grpc.MethodDescriptor<com.grpc.client.stub.Airsell.SellRequest,
      com.grpc.client.stub.Airsell.SellResponse> getUpdateSellMethod() {
    io.grpc.MethodDescriptor<com.grpc.client.stub.Airsell.SellRequest, com.grpc.client.stub.Airsell.SellResponse> getUpdateSellMethod;
  ...
  private static volatile io.grpc.MethodDescriptor<com.grpc.client.stub.Airsell.Empty,
      com.grpc.client.stub.Airsell.SellResponse> getGetSellsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getSells",
      requestType = com.grpc.client.stub.Airsell.Empty.class,
      responseType = com.grpc.client.stub.Airsell.SellResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.grpc.client.stub.Airsell.Empty,
      com.grpc.client.stub.Airsell.SellResponse> getGetSellsMethod() {
    io.grpc.MethodDescriptor<com.grpc.client.stub.Airsell.Empty, com.grpc.client.stub.Airsell.SellResponse> getGetSellsMethod;
    if ((getGetSellsMethod = SellGrpc.getGetSellsMethod) == null) {
      synchronized (SellGrpc.class) {
        if ((getGetSellsMethod = SellGrpc.getGetSellsMethod) == null) {
          SellGrpc.getGetSellsMethod = getGetSellsMethod = 
              io.grpc.MethodDescriptor.<com.grpc.client.stub.Airsell.Empty, com.grpc.client.stub.Airsell.SellResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "com.grpc.poc.Sell", "getSells"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.grpc.client.stub.Airsell.Empty.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.grpc.client.stub.Airsell.SellResponse.getDefaultInstance()))
  ...
  public static abstract class SellImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void createSell(com.grpc.client.stub.Airsell.SellRequest request,
        io.grpc.stub.StreamObserver<com.grpc.client.stub.Airsell.SellResponse> responseObserver) {
      asyncUnimplementedUnaryCall(getCreateSellMethod(), responseObserver);
    }

    /**
     */
    public void updateSell(com.grpc.client.stub.Airsell.SellRequest request,
        io.grpc.stub.StreamObserver<com.grpc.client.stub.Airsell.SellResponse> responseObserver) {
    ...
    /**
     */
    public void getSells(com.grpc.client.stub.Airsell.Empty request,
        io.grpc.stub.StreamObserver<com.grpc.client.stub.Airsell.SellResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.grpc.client.stub.Airsell.SellRequest,
                com.grpc.client.stub.Airsell.SellResponse>(
          ...
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.grpc.client.stub.Airsell.Empty,
                com.grpc.client.stub.Airsell.SellResponse>(
  ...
  public static final class SellBlockingStub extends io.grpc.stub.AbstractStub<SellBlockingStub> {
    ...
    /**
     */
    public com.grpc.client.stub.Airsell.SellResponse createSell(com.grpc.client.stub.Airsell.SellRequest request) {
    ...
    /**
     */
    public com.grpc.client.stub.Airsell.SellResponse updateSell(com.grpc.client.stub.Airsell.SellRequest request) {
      return blockingUnaryCall(
    ...
    /**
     */
    public com.grpc.client.stub.Airsell.SellResponse getSells(com.grpc.client.stub.Airsell.Empty request) {
      return blockingUnaryCall(
  ...
  public static final class SellFutureStub extends io.grpc.stub.AbstractStub<SellFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.grpc.client.stub.Airsell.SellResponse> createSell(
        com.grpc.client.stub.Airsell.SellRequest request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.grpc.client.stub.Airsell.SellResponse> updateSell(
        com.grpc.client.stub.Airsell.SellRequest request) {
      return futureUnaryCall(
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.grpc.client.stub.Airsell.SellResponse> getSells(
        com.grpc.client.stub.Airsell.Empty request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CREATE_SELL:
          serviceImpl.createSell((com.grpc.client.stub.Airsell.SellRequest) request,
              (io.grpc.stub.StreamObserver<com.grpc.client.stub.Airsell.SellResponse>) responseObserver);
          break;
        case METHODID_UPDATE_SELL:
          serviceImpl.updateSell((com.grpc.client.stub.Airsell.SellRequest) request,
              (io.grpc.stub.StreamObserver<com.grpc.client.stub.Airsell.SellResponse>) responseObserver);
          break;
        case METHODID_GET_SELLS:
          serviceImpl.getSells((com.grpc.client.stub.Airsell.Empty) request,
              (io.grpc.stub.StreamObserver<com.grpc.client.stub.Airsell.SellResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class SellBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.grpc.client.stub.Airsell.getDescriptor();
    }
